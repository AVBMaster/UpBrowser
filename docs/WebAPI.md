根据Mozilla提供的 MDN 文档，我已将“规范”和“接口”列表完整整理如下。所有链接均基于 `https://developer.mozilla.org/en-US/docs/Web/API/` 拼接而成，并严格遵循原始文档的顺序与内容，确保无一遗漏。
...
| CSS Typed Object Model API | https://developer.mozilla.org/en-US/docs/Web/API/CSS_Typed_Object_Model_API |
...
| Media Source API | https://developer.mozilla.org/en-US/docs/Web/API/Media_Source_API |
...
| AudioPlaybackStats | https://developer.mozilla.org/en-US/docs/Web/API/AudioPlaybackStats |
...
| ClipboardChangeEvent | https://developer.mozilla.org/en-US/docs/Web/API/ClipboardChangeEvent |
...
| CrashReport | https://developer.mozilla.org/en-US/docs/Web/API/CrashReport |
| CrashReportContext | https://developer.mozilla.org/en-US/docs/Web/API/CrashReportContext |
...
| DeprecationReport | https://developer.mozilla.org/en-US/docs/Web/API/DeprecationReport |
...
| IntegrityViolationReport | https://developer.mozilla.org/en-US/docs/Web/API/IntegrityViolationReport |
| InterestEvent | https://developer.mozilla.org/en-US/docs/Web/API/InterestEvent |
| IntersectionObserver | https://developer.mozilla.org/en-US/docs/Web/API/IntersectionObserver |
| IntersectionObserverEntry | https://developer.mozilla.org/en-US/docs/Web/API/IntersectionObserverEntry |
| InterventionReport | https://developer.mozilla.org/en-US/docs/Web/API/InterventionReport |
...
| PasswordCredentialInit | https://developer.mozilla.org/en-US/docs/Web/API/PasswordCredentialInit |
...
| PerformanceTimingConfidence | https://developer.mozilla.org/en-US/docs/Web/API/PerformanceTimingConfidence |
...
| Point | https://developer.mozilla.org/en-US/docs/Web/API/Point |
...
| SharedStorageOperation | https://developer.mozilla.org/en-US/docs/Web/API/SharedStorageOperation |
| SharedStorageRunOperation | https://developer.mozilla.org/en-US/docs/Web/API/SharedStorageRunOperation |
| SharedStorageSelectURLOperation | https://developer.mozilla.org/en-US/docs/Web/API/SharedStorageSelectURLOperation |
...
| WindowSharedStorage | https://developer.mozilla.org/en-US/docs/Web/API/WindowSharedStorage |
...
| WorkletSharedStorage | https://developer.mozilla.org/en-US/docs/Web/API/WorkletSharedStorage |
...
| XRVisibilityMaskChangeEvent | https://developer.mozilla.org/en-US/docs/Web/API/XRVisibilityMaskChangeEvent |
...
以上就是根据 MDN 文档整理出的全部“规范”和“接口”列表。